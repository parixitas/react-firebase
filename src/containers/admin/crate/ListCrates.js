...
class ListCrates extends Component {
    constructor() {
        super();
        this.state = {
            data: [],
                    ...
                    <div className="container-fluid">
                        <div className="row bg-title">
                            ...
                            <div className="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                                <AddCrate buttonLabel="Add" modalTitle={`Add New ${this.props.baseObject}`} handleRefresh={this.getData} />
                            </div>
                        </div>
                        <div className="row">
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        Cell: ({ original }) => (
                                                            <Col className="text-right">
                                                                <EditCrate buttonLabel="Edit" modalTitle="Edit Crate" dataRow={original} uniqueId={original.key} handleRefresh={this.getData} />
                                                            </Col>
                                                        )
                                                    },
                                                ]
