...
class AddSetType extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            ...INITIAL_STATE,
    ...
    render() {
        ...
        return (
            <div>
               <Button type="button" onClick={this.toggle} className="btn btn-info warningbtn pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i className="fa  fa-plus-circle"></i> Add New Set Type</Button>
                <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className} backdrop="static">
                    <Form onSubmit={this.onSubmit}>
                        ...
                        <ModalBody>
                            ...
                            <FormGroup row>
                                <Label for="diceSlots" sm={3}>Dice Slots</Label>
                                <Col sm={9}>
                                    <Input
                                        value={diceSlots}
                                        onChange={e => this.setState(byPropKey('diceSlots', e.target.value))}
                                        type="text"
                                    />
                                </Col>
                            </FormGroup>
