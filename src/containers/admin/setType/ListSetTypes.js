...
import AddSetType from './AddSetType';
import EditSetType from './EditSetType';
import { Button, Col } from 'reactstrap';
import $ from 'jquery';

class ListSetTypes extends Component {
    constructor() {
        super();
        this.state = {
            data: [],
