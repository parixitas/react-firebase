...
class AddProductLine extends Component {
    ...
    render() {
        ...
        const isInvalid = title ==='' || manufacturer ==='';

        return (
            <div className="productline_modal">
               <Button type="button" onClick={this.toggle} className="btn btn-info warningbtn pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i className="fa  fa-plus-circle"></i> Add New Product Line</Button>
