...
import AddStyleType from './AddStyleType';
import EditStyleType from './EditStyleType';
import { Button, Col } from 'reactstrap';
import $ from 'jquery';

class ListStyleTypes extends Component {
    constructor() {
        super();
        this.state = {
            data: [],
