...
import AddDieType from './AddDieType';
import EditDieType from './EditDieType';
import { Button, Col } from 'reactstrap';
import $ from 'jquery';

class ListDieTypes extends Component {
    constructor() {
        super();
        this.state = {
            data: [],
