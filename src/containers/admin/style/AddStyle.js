...
class AddStyle extends Component {
    ...
    render() {
        ...
        const isInvalid = title ==='' || styleType ==='' || colorCount < 1;

        return (
            <div>
                <Button type="button" onClick={this.toggle} className="btn btn-info warningbtn pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i className="fa  fa-plus-circle"></i> Add New Style</Button>
